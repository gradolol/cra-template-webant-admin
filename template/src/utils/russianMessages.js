export default {
  ra: {
    ...
    message: {
      ...
      yes: "Да",
      email_already_exist: "Данная эл. почта уже занята",
      phone_already_exist: "Данный номер телефона уже занят",
      username_already_exist: "Данный логин уже занят",
    },
    navigation: {
    ...
    validation: {
      ...
      phone:
        "Номер телефона должен состоять только из цифр и должен быть от %{min} до %{max} символов",
      email: "Указана некорректная эл. почта. Пример: example@mail.ru",
    },
    poles: {
      title: "Заголовок",
      text: "Содержание",
